...
class TestOrderRepository:
    ...
    async def test_create_order(self,
        ...
        order = await order_repository.create(OrderCreate(
            user_id=user.id,
            address_id=address_repository.create(AddressCreate(country="America", city="NY", street="Washington")),
    ...
    async def test_edit_order(self,
        ...
        updated_order = await order_repository.update(order.id, OrderUpdate(address=update_address.id))
